...
const std::array<gamemode, 6> BUILTIN_GAMEMODES{{
	{
		.builtin = true,
		.name = "gm_classic",
		.author = "TRDario",
		...
		.song = "classic",
		.player{.life_fragment_spawn_interval = beats_bpm(80, 115)},
		.ball{.starting_count = 1,
			  .max_count = 30,
			  .spawn_interval = beats_bpm(16, 115),
			  .initial_size = 20,
			  .size_step = 0,
	...
	},
	{
		...
		.song = "chonk",
		.player{.life_fragment_spawn_interval = beats_bpm(64, 98),
			    .hitbox_radius = 30},
		.ball{.starting_count = 3,
			  .max_count = 10,
			  .spawn_interval = beats_bpm(32, 98),
			  .initial_size = 65,
			  .size_step = 0,
	...
	},
	{
		...
		.song = "swarm",
		.player{.life_fragment_spawn_interval = beats_bpm(64, 140),
				.hitbox_radius = 8,
				.inertia_factor = 0.05f},
		.ball{.starting_count = 5,
			  .max_count = 40,
			  .spawn_interval = beats_bpm(8, 140),
			  .initial_size = 10,
			  .size_step = 0,
	...
	},
	{
		...
		.name = "gm_speedy",
		.author = "TRDario",
		.description = "gm_speedy_d",
		.song = "speedy",
		.player{.starting_lives = 0,
			    .life_fragment_spawn_interval = beats_bpm(48, 170)},
		.ball{.starting_count = 1,
			  .max_count = 12,
			  .spawn_interval = beats_bpm(16, 170),
			  .initial_size = 15,
			  .size_step = 0,
	...
	},
	{
		...
		.name = "gm_focus",
		.author = "TRDario",
		.description = "gm_focus_d",
		.song = "focus",
		.player{.starting_lives = 0,
			    .spawn_life_fragments = false,
			    .hitbox_radius = 5},
		.ball{.starting_count = 165,
			  .max_count = 165,
			  .initial_size = 10,
			  .size_step = 0,
	...
	},
	{
		...
		.song = "variety",
		.player{.starting_lives = 0,
			    .life_fragment_spawn_interval = beats_bpm(32, 125)},
		.ball{.starting_count = 1,
			  .max_count = 25,
			  .spawn_interval = beats_bpm(8, 125),
			  .initial_size = 10,
			  .size_step = 1.5f,
			  .initial_velocity = 300,
			  .velocity_step = 0},
