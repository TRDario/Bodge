...
class game {
  public:
	...
	game(gamemode gamemode, std::uint64_t rng_seed);
...
class active_game : public game {
  public:
	...
	// Creates a new game.
	active_game(struct gamemode gamemode, std::uint64_t seed = engine::rng.generate<std::uint64_t>());
...
class replay_game : public game {
  public:
	...
	replay_game(struct gamemode gamemode, replay replay);
